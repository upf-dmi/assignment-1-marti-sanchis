...
heart_disease %>% dplyr::select(c(Age,Gender,ChestPain,MajorVessels,Thalassemia,HeartDiseaseDiagnosis)) %>% 
...
ggpairs(heart_disease,
        ...
        aes(color = HeartDiseaseDiagnosis)) +  # Aquí pasas el mapeo de color correctamente
  theme_minimal() +
  labs(title = "Pair Plot of Predictive Variables by Heart Disease Diagnosis")
